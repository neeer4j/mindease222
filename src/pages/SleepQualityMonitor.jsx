...
const SleepLogForm = ({ onSubmit, initialValues = {}, factorOptions, isEditing }) => {
    ...
    const SleepHistoryChart = ({ sleepLogs, chartOptions: baseChartOptions, theme }) => {
        ...
        useEffect(() => {
            ...
            setChartOptions({
                ...baseChartOptions,
                theme: {
                    mode: theme.palette.mode, // Set theme mode for ApexCharts
                },
                ...
                xaxis: {
                    ...
                    axisBorder: {
                        ...baseChartOptions.xaxis.axisBorder,
                        color: theme.palette.divider,
                    },
                    axisTicks: {
                        ...baseChartOptions.xaxis.axisTicks,
                        color: theme.palette.divider,
                    },
                },
                yaxis: {
                    ...
                    axisBorder: {
                        ...baseChartOptions.yaxis.axisBorder,
                        color: theme.palette.divider,
                    },
                    axisTicks: {
                        ...baseChartOptions.yaxis.axisTicks,
                        color: theme.palette.divider,
                    },
                    title: {
                ...
                tooltip: {
                    ...
                    theme: theme.palette.mode, // Adjust tooltip theme
                    style: {
                        fontSize: '12px',
                    },
                },
        ...
        }, [sleepLogs, theme.palette.mode]); // Re-run when sleepLogs or theme mode changes
    ...
    const SleepQualityMonitor = () => {
        const theme = useTheme();
        const { sleepLogs, addSleepLog, deleteSleepLog, loading, error, success } = useContext(SleepContext);
        ...
        const baseChartOptions = {
            ...
            tooltip: {
                ...
                theme: theme.palette.mode, // Adjust tooltip theme based on mode
                style: {
                    fontSize: '12px',
                },
            },
        ...
        const handleDeleteLog = async (id) => { // Updated handleDeleteLog to async
            try {
                await deleteSleepLog(id); // Call deleteSleepLog from context
                showSnackbar('Sleep log deleted successfully from Firebase!', 'success'); // Success message for Firebase delete
            } catch (error) {
                console.error("Error deleting sleep log:", error);
                showSnackbar('Failed to delete sleep log from Firebase.', 'error'); // Error message for Firebase delete
            }
        };
